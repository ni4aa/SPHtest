...
DOMAIN_X_LIM = np.array([-DOMAIN_WIDTH/2, DOMAIN_WIDTH/2])
...
if __name__ == '__main__':
    ...
    # positions = np.array([DOMAIN_WIDTH, DOMAIN_HEIGHT, DOMAIN_DEEP]) * np.random.random((PARTICLES, 3))
    # positions = positions - np.array([DOMAIN_WIDTH, DOMAIN_HEIGHT, DOMAIN_DEEP])/2

    # positions = set_positions(10, 20, 10)
